...
class ST7789(object):
    ...
    def __init__(self, port, cs, dc, backlight=None, rst=None, width=240,
        ...
        wiringpi.pinMode(self._rst, self.GPIO.OUTPUT)
        wiringpi.pinMode(self._dc, self.GPIO.OUTPUT)
        wiringpi.pinMode(self._backlight, self.GPIO.OUTPUT)
    ...
    def send(self, data, is_data=True, chunk_size=4096):
        ...
        wiringpi.digitalWrite(self._dc, 1 if is_data else 0)
    ...
    def display_entire_window(self, image):
